...
namespace sainsburys.co.uk
{
    public class Importer : Parser
    {
        ...
        public override Dictionary<int, string> getTitles()
        {
            ...
            string prodData = client.DownloadString("https://www.sainsburys.co.uk/groceries-api/gol-services/product/v1/product?filter[product_seo_url]=gb%2Fgroceries%2F" + seo_url);
